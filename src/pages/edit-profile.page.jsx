...
const EditProfile = () => {
  ...
  const [updatedProfileImg, setUpdateProfileImg] = useState(false);
          ...
          <form ref={editProfileForm}>
            ...
            <div className="flex flex-col lg:flex-row items-start py-10 gap-8 lg:gap-10">
              <div className="max-lg:center mb-5 ">
                ...
                <button className="btn-light mt-5 max-lg:center lg:w-full px-10" onClick={handleImgeUpload}>Upload</button>
              </div>
              ...
              <div className="w-full">
                ...
                <textarea name="bio" maxLength={bioLimit} defaultValue={bio}
                  className="input-box h-64 lg:h-40 resize-none leading-7 mt-5 pl-5" placeholder="Bio" onChange={handleCharactesChange}></textarea>
