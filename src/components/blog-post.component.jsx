...
const BlogPostCart = ({ content, author }) => {
  ...
  return (
    <Link to={`/blog/${id}`} className="flex gap-8 items-center border-b border-grey pb-5 mb-4">
      <div className="w-full">
        ...
        <p className="my-3 text-xl font-gelasio leading-7 max-sm:hidden md:max-[1110px]:hidden">{des}</p>

        <div className="flex gap-4 mt-7">
          <span className="btn-light py-1 px-4">{tags}</span>
